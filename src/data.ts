export const initialData = {
  hospitals: {
    ...
    bkk: {
      ...
      nameEn: 'Bangkok Hospital (@BangkokHospital)',
      color: '#1A3B2B',
      bg: '#f0fdf4',
      badgeBg: '#1A3B2B',
      borderTop: '#1A3B2B',
    ...
    bum: {
      ...
      nameEn: 'Bumrungrad International Hospital (@bumrungrad)',
      color: '#128A84',
      bg: '#f0fdfa',
      badgeBg: '#128A84',
      borderTop: '#128A84',
    ...
    med: {
      id: 'med',
      name: 'โรงพยาบาลเมดพาร์ค',
      nameEn: 'MedPark Hospital (@medpark.thailand)',
      color: '#E27447',
      bg: '#fff7ed',
      badgeBg: '#E27447',
      borderTop: '#E27447',
    ...
    sam: {
      ...
      nameEn: 'Samitivej Hospital (@Samitivej)',
      color: '#7B4FA0',
      bg: '#faf5ff',
      badgeBg: '#7B4FA0',
      borderTop: '#7B4FA0',
  ...
  competitorsData: [
    ...
    {
      name: 'โรงพยาบาลสมิติเวช สุขุมวิท (Samitivej Sukhumvit Hospital)',
      logo: 'https://www.samitivejhospitals.com/_nuxt/img/logo.5ada14b.svg',
      color: '#7B4FA0',
      links: [
        { type: 'fb', icon: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/2021_Facebook_icon.svg', url: 'https://www.facebook.com/ads/library/?active_status=active&ad_type=all&country=ALL&is_targeted_country=false&media_type=all&search_type=page&sort_data%5Bdirection%5D=desc&sort_data%5Bmode%5D=total_impressions&view_all_page_id=113238002044013', text: 'FB Ads Library - Main Page' },
        { type: 'fb', icon: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/2021_Facebook_icon.svg', url: 'https://www.facebook.com/ads/library/?active_status=active&ad_type=all&country=ALL&is_targeted_country=false&media_type=all&search_type=page&sort_data%5Bdirection%5D=desc&sort_data%5Bmode%5D=total_impressions&view_all_page_id=204250892958095', text: 'FB Ads - Page 2' },
